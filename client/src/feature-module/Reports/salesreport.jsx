...
import { useGetSellReportQuery } from "../../core/redux/api/sellsInvoice/sellInvoice";
...
const SalesReport = () => {
  ...
  const { data: sellReportData, isLoading: sellReportLoading } =
